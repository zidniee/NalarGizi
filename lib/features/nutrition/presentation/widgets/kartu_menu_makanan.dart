...
class KartuMenuMakanan extends StatelessWidget {
  ...
  final bool isAddMode; // True untuk kotak Tambah Menu
  ...
  const KartuMenuMakanan({
    ...
    this.addLabel = 'Tambah Menu',
    this.addPlaceholder = 'Belum ada catatan makan',
    this.onTap,
  });
    ...
    if (isAddMode) {
      return GestureDetector(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              Text(addPlaceholder, style: const TextStyle(color: Colors.grey, fontSize: 14)),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    const Icon(Icons.add, color: Color(0xFFFF7A00), size: 18),
                    const SizedBox(width: 4),
                    Text(addLabel, style: const TextStyle(color: Color(0xFFFF7A00), fontWeight: FontWeight.bold)),
                  ],
                ),
              ),
            ],
